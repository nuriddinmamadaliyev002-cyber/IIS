...
function renderTable(d) {
  ...
  if (!d.length) {
    tb.innerHTML = '<tr><td colspan="7"><div class="empty-state"><div class="empty-state-icon"><img src="img/oqituvchi-icon.png" alt="" style="height:1em;width:1em;object-fit:contain;vertical-align:-0.15em;"></div><p>O\'qituvchi topilmadi</p></div></td></tr>';
    return;
  }
...
function renderMobile(d) {
  ...
  if (!d.length) {
    el.innerHTML = '<div class="empty-state"><div class="empty-state-icon"><img src="img/oqituvchi-icon.png" alt="" style="height:1em;width:1em;object-fit:contain;vertical-align:-0.15em;"></div><p>O\'qituvchi topilmadi</p></div>';
    return;
  }
